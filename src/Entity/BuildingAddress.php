...
class BuildingAddress extends AbstractEntity
{
    ...
    #[ORM\Column('egaid', Types::INTEGER, 9, options: ['comment' => "N° d'identification fédérale de l'adresse de bâtiments selon le RegBL",
        'unsigned' => true,
    ])]
     ...
     */
    #[ORM\Column(type: Types::SMALLINT, options: ['comment' => "Numéro d'identification de l'entrée de bâtiment selon le RegBL",
    ])]
    ...
    #[ORM\Column(length: 50, nullable: true, options: ['comment' => 'Nom du bâtiment, uniquement en l’absence de valeur pour address_number',
    ])]
    private ?string $buildingName = null;

    #[ORM\Column(length: 18, enumType: BuildingCategory::class, options: [
        'comment' => 'Subdivision des bâtiments selon leur destination, selon le RegBL',
    ])]
